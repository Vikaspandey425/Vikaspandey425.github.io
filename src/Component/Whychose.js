...
class Whychose extends React.Component {
  ...
  <section id="whychose-section" className="p-100 pb-2 bg-one-dark">
    <div className="container" data-aos="fade-up">
            <div className="section-title">
                <h2>Whycho<span style={{color:'#fabf15'}}>se Us</span> </h2>
            </div>
      <div className="row d-flex align-items-end">

                <div className="col-md-6 text-center">
                    <img src="assets\img\whychose-us.png" alt="image" className="img-fluid" style={{width: '400px'}}/>
                </div>
